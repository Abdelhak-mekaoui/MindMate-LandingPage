...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} bg-white  w-full flex items-center py-3 top-0 fixed z-20 bg-primary`}
    >
      <div className=" w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <img src={logo} alt="logo" className="w-[4rem] h-[4rem] object-contain" />
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          ...
          <div
            className={`${
              toggle ? "flex" : "hidden"
            } p-6 bg-[#461066] absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}
          >
